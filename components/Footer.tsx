...
const InstagramIcon = () => (
  <svg viewBox="0 0 24 24" className="h-5 w-5" fill="url(#igFooterGradient)">
    <defs>
      <radialGradient id="igFooterGradient" cx="30%" cy="107%" r="150%">
...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: GitHubIcon, href: "https://github.com/Skirkie", label: "GitHub" },
    { icon: InstagramIcon, href: "https://www.instagram.com/arksieol0gy/", label: "Instagram" },
    { icon: FacebookIcon, href: "https://www.facebook.com/kent.arksicorro", label: "Facebook" },
  ];
    ...
    <footer className="bg-neutral-50 dark:bg-neutral-900/50 border-t border-neutral-200 dark:border-neutral-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-neutral-600 dark:text-neutral-400">
          <p>© {currentYear} KentDev. All rights reserved.</p>
